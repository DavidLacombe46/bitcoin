...
public:
    ...
    MutableTransactionSignatureCreator(const CMutableTransaction* txToIn, unsigned int nInIn, const CAmount& amountIn, PrecomputedTransactionData* txdata, int nHashTypeIn = SIGHASH_ALL);
